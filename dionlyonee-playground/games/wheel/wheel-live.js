...
const waitingContainer = document.getElementById('waiting-scene-container');
...
function render(state) {
  if (!state || state.phase === 'no-puzzle') {
    renderWaiting();
    return;
  }
...
function renderWaiting() {
  ...
  showingWaiting = true;
  renderWaitingScene(waitingContainer, 'The wheel starts spinning any moment now...');
}
